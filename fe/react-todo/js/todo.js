...
var Todo = React.createClass({displayName: "Todo",
  ...
  render: function() {
    return React.createElement("div", null, 
      React.createElement(TodoForm, {save: this.save}), 
      React.createElement(TodoList, {get: this.get, remove: this.remove, update: this.update})
    )
  }
});
...
var TodoForm = React.createClass({displayName: "TodoForm",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: classSet, "data-length": this.state.length - this.state.value.length}, 
        ...
        React.createElement("input", {className: "addTodo", type: "submit", onClick: this.handle})
      )
    );
  }
});
...
var TodoItem = React.createClass({displayName: "TodoItem",
  ...
  render: function() {
    ...
    */
    return React.createElement("li", {className: "todoitem", "data-uuid": this.props.item.uuid, onClick: this.handle, ref: "item"}, 
      React.createElement("span", {className: classSet}, this.props.item.value), 
      React.createElement("a", {className: "delete", "data-action": "remove"}, "删除"), 
      React.createElement("a", {className: "update", "data-action": "update"}, "标记")
    )
  }
});
  ...
  */
  render: function() {
    ...
    var todoItems = this.state.list.map(function(item, index) {
      return React.createElement(TodoItem, React.__spread({},  self.props, {item: item, key: item.uuid}));
    });
